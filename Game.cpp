...
void Game::Initialize(){
	...
	mapobj.Initialize();
	player1.Initialize(vec3(20,10,-10),1,Crossbow,RedTeam);
...
void Game::DrawInitialize(){
	...
	flname=(char*)"Data/charamodel/char2/char2_ene_body1.mqo";
	mqomodel[7]=mqoCreateModel(flname,0.0035);
	flname=(char*)"Data/charamodel/char2/char2_ene_body2.mqo";
	...
	flname=(char*)"Data/charamodel/拠点/castle2_exp.mqo";
