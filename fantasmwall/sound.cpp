...
void SoundInit() {
	...
	se_buf[9] = alureCreateBufferFromFile("Data/SE/rifle.wav");
	...
	se_buf[15] = alureCreateBufferFromFile("Data/SE/magic.wav");
	se_buf[16] = alureCreateBufferFromFile("Data/SE/magicstick.wav");;
