...
//char*      model_file = "Data/obje/holder35.obj";		/* name of the obect file */
...
//    glmWriteOBJ(model, (char*)"out.obj", GLM_SMOOTH | GLM_MATERIAL);
//    break;
//
//  case 'R':
//    {
...
//
//void
//mousee(int button, int state, int x, int y)
//{
//  GLdouble model[4*4];
//  GLdouble proj[4*4];
//  GLint view[4];
